...
public abstract class ChessBoard implements Iterable<ChessMan>, Observer, Serializable {
  ...
  /*
   * previous and previous previous state for the fallback function
   */
  protected ChessMan[][] pBoard;
  protected ChessMan[][] ppBoard;

  /*
   * user's action is select and move/eat. temperate save's the state before user complete his
   * action
   */
